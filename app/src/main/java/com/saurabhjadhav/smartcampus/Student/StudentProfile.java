                        ...
                        firebaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(StudentProfile.this, "Account Deleted", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(StudentProfile.this, MainActivity.class);
                                    startActivity(intent);
                                    finish();
                                } else {
                                    Toast.makeText(StudentProfile.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
    ...
    private void uploadImage(Uri imageUri) {
        ...
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(StudentProfile.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
