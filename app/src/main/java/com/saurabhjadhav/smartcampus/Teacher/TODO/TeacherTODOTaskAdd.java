...
import com.saurabhjadhav.smartcampus.Student.TODO.StudentTODOModel;

public class TeacherTODOTaskAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_todotask_add);
        ...
        backToSDash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TeacherTODOTaskAdd.this, TeacherTODO.class));
                finish();
            }
        });
    ...
    private void saveNote() {
        ...
        CollectionReference myTaskRef = FirebaseFirestore.getInstance()
                .collection("TEACHER TASKS").document(user).collection("TASKS");
